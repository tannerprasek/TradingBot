...
JS_VER = "pr21-ignore-foreign-nav"
...
(function () {{
  var SS_VER = "{JS_VER}";
  if (window.__FD_SS_BOUND__ === SS_VER) return;
  window.__FD_SS_BOUND__ = SS_VER;
  window.__FD_SS_IGNORE_FOREIGN_NAV__ = true;
  ...
  function kindOf(btn) {{
    ...
    if (btn.id === "fd-nav-breakout" || btn.getAttribute("data-fd-breakout") === "1") return "";
    if (btn.id === "fd-nav-breakdown" || btn.getAttribute("data-fd-breakdown") === "1") return "";
  ...
  window.__FD_SS_KIND_OF__ = kindOf;
