...
<nav class="topnav" aria-label="Factor Desk">
  ...
  <button type="button" class="nav-btn" data-view="breakout" data-fd-breakout="1">Breakout</button>
  <button type="button" class="nav-btn" data-view="breakdown" data-fd-breakdown="1">Breakdown</button>
