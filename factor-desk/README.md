...
factor-desk/
  ...
  paper_trade.py         # paper Buy/Sell on dense cardHTML cards
...
Paper Buy/Sell on dense MOM cards (localStorage, 1 unit, no brokerage): [docs/PAPER-TRADE.md](docs/PAPER-TRADE.md).
